...
var _amapWx = _interopRequireDefault(__webpack_require__(/*! ../js_sdk/amap-wx.js */ 28));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} //sdk文件路径  需要下载微信小程序sdk文件
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.myMixins = void 0;var myMixins = {
...
var webscoket = function webscoket(token) {
  ...
  uni.onSocketMessage( /*#__PURE__*/function () {var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(res) {var _yield$JSON$parse, client_id, type;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
                JSON.parse(res.data));case 2:_yield$JSON$parse = _context.sent;client_id = _yield$JSON$parse.client_id;type = _yield$JSON$parse.type;
...
// 发送消息
exports.webscoket = webscoket;var sendSocketMessage = function sendSocketMessage(msg) {
  if (socketOpen) {
